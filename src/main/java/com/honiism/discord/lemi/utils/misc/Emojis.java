...
public class Emojis {
    ...
    // unicode letters
    public static final String[] UNICODE_LETTERS = {
        "\uD83C\uDDE6",
        "\uD83C\uDDE7",
        "\uD83C\uDDE8",
        "\uD83C\uDDE9",
    ...
    // unicode letters
    public static final String[] UNICODE_NUMBERS = {
        "\u0030\u20E3",
        "\u0031\u20E3",
        "\u0032\u20E3",
        "\u0033\u20E3",
    ...
    // numbers
    public static final String NUM_0 = "\u0030\u20E3";
    public static final String NUM_1 = "\u0031\u20E3";
    public static final String NUM_2 = "\u0032\u20E3";
    public static final String NUM_3 = "\u0033\u20E3";
    public static final String NUM_4 = "\u0034\u20E3";
    public static final String NUM_5 = "\u0035\u20E3";
    public static final String NUM_6 = "\u0036\u20E3";
    public static final String NUM_7 = "\u0037\u20E3";
    public static final String NUM_8 = "\u0038\u20E3";
    public static final String NUM_9 = "\u0039\u20E3";

    // extras
    public static final String LEFT_ARROW = "\u25C0";
    public static final String RIGHT_ARROW = "\u25B6";
    public static final String PAUSE_BUTTON = "\u23F8";
    public static final String SKIP_TO_START_BUTTON = "\u23EE";
